...
import flightservicescode.reader.mycomponent.MyStreamReaderImpl
import flightservicescode.transformer.mycomponent.MyStreamTransformerImpl
import flightservicescode.writer.mycomponent.MyStreamWriterImpl
